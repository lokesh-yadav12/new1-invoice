			...
			<div className="max-w-6xl mx-auto px-4">
				...
				<div ref={invoiceRef} className="bg-white shadow-lg p-2 sm:p-12">
					...
					<div className="flex justify-between items-start mb-8">
						<div>
							<h1 className="text-2xl sm:text-4xl font-bold text-purple-600 mb-3">Quotation</h1>
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-8">
						{/* From */}
						<div>
							<h3 className="text-lg font-bold text-purple-600 mb-3">From</h3>
						...
						{/* To */}
						<div>
							<h3 className="text-lg font-bold text-purple-600 mb-3">To</h3>
							{selectedClientData ? (
								<div className="bg-purple-50 p-5 rounded-lg">
					...
					{!invoiceData.advancedOptions.hidePlaceCountry && (
						<div className="flex flex-col sm:flex-row gap-3 sm:gap-0 justify-between mb-6 text-sm">
							<div>
