			...
			<div className="max-w-6xl mx-auto px-4">
				...
				<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6 print:hidden">
					<div className="flex flex-col items-center justify-between">
						<h2 className="text-xl sm:text-2xl font-bold text-gray-900">Delivery Challan Preview</h2>
				...
				{/* Invoice Document */}
				<div ref={invoiceRef} className="bg-white shadow-lg p-2 sm:p-12">
					{/* Header Section */}
					<div className="flex justify-between items-start mb-8">
						<div>
							<h1 className="text-2xl sm:text-4xl font-bold text-purple-600 mb-3">Delivery Challan</h1>
					...
					<div className="mb-6">
						<div className="flex flex-col gap-2 max-w-md">
							<div className="flex">
								<span className="text-gray-600 w-32">Challan No</span>
								<span className="font-semibold text-gray-900">{invoiceData.invoiceNo}</span>
							</div>

							<div className="flex">
								<span className="text-gray-600 w-32">Challan Date</span>
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-8">
						{/* Consignor */}
						<div>
							<h3 className="text-lg font-bold text-purple-600 mb-3">Consignor</h3>
						...
						{/* Consignee */}
						<div>
							<h3 className="text-lg font-bold text-purple-600 mb-3">Consignee</h3>
							{selectedClientData ? (
								<div className="bg-purple-50 p-5 rounded-lg">
					...
					{!invoiceData.advancedOptions.hidePlaceCountry && (
						<div className="flex flex-col sm:flex-row justify-between mb-6 text-sm gap-4 sm:gap-0">
							<div>
