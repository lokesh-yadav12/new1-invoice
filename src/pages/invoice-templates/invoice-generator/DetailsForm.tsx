  ...
  return (
    <div className="p-2 sm:p-3 md:p-6 lg:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 lg:gap-12 lg:px-8 xl:px-20">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 sticky top-0 bg-white z-10">
              <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Custom Fields</h2>
              <button
            ...
            <div className="p-4 sm:p-6">
              <div className="space-y-3 mb-6 max-h-60 sm:max-h-96 overflow-y-auto">
                {customFields.length === 0 ? (
                  <p className="text-gray-500 text-center py-8 text-sm sm:text-base">No custom fields added yet</p>
                ) : (
                  customFields.map((field) => (
                    <div
                      key={field.id}
                      className="flex items-center justify-between p-3 sm:p-4 bg-purple-50 rounded-lg border border-purple-100 hover:border-purple-200 transition-colors"
                    >
                      <div className="flex-1 min-w-0 pr-2">
                        <p className="font-medium text-gray-900 text-sm sm:text-base truncate">{field.label}</p>
                        <p className="text-xs sm:text-sm text-gray-500 truncate">{field.value || 'No value'}</p>
                      </div>
                      <button
                        onClick={() => handleDeleteCustomField(field.id)}
                        className="text-gray-400 hover:text-red-500 transition-colors flex-shrink-0"
              ...
              <button
                ...
                className="w-full py-2.5 sm:py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-all duration-200 font-medium shadow-sm hover:shadow-md text-sm sm:text-base"
              >
      ...
      {showAddFieldModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 sticky top-0 bg-white z-10">
              <h2 className="text-base sm:text-lg font-semibold text-gray-900">Add Custom Field</h2>
              <button
                onClick={() => {
                  setShowAddFieldModal(false);
                  setNewFieldLabel('');
            ...
            <div className="p-4 sm:p-6">
              <div className="space-y-4 sm:space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 sm:px-4 py-2 sm:py-2.5 border border-gray-300 rounded-lg outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all text-sm sm:text-base"
                  />
                </div>
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  />
                  <label htmlFor="default-value" className="text-gray-700 cursor-pointer text-sm sm:text-base">
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3 mt-6 sm:mt-8">
                <button
                  ...
                  className="w-full sm:w-auto px-4 sm:px-6 py-2.5 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors font-medium text-sm sm:text-base order-2 sm:order-1"
                >
                  Cancel
                </button>
                <button
                  onClick={handleSaveCustomField}
                  className="w-full sm:w-auto px-4 sm:px-6 py-2.5 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-all duration-200 font-medium shadow-sm hover:shadow-md text-sm sm:text-base order-1 sm:order-2"
                >
                  Save
                </button>
              </div>
