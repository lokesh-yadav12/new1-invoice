			...
			<div className="max-w-6xl mx-auto px-4">
				...
				<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6 print:hidden">
					<div className="flex flex-col sm:flex-row items-center justify-between">
						<h2 className="text-xl sm:text-2xlsm-pb-0 pb-2 font-bold text-gray-900">GST Invoice Preview</h2>
				...
				<div ref={invoiceRef} className="bg-white shadow-lg p-2 sm:p-12">
					...
					<div className="flex justify-between items-start mb-8">
						<div>
							<h1 className="text-2xl sm:text-4xl font-bold text-purple-600 mb-3">GST Invoice</h1>
