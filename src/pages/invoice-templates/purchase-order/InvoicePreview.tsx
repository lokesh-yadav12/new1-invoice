			...
			<div className="max-w-6xl mx-auto px-4">
				...
				<div ref={invoiceRef} className="bg-white shadow-lg p-2 sm:p-12">
					...
					<div className="flex justify-between items-start mb-8">
						<div>
							<h1 className="text-2xl sm:text-4xl font-bold text-purple-600 mb-3">Purchase Order</h1>
					...
					<div className="mb-6">
						<div className="flex flex-col gap-2 max-w-md">
							<div className="flex">
								<span className="text-gray-600 w-32">Purchase No</span>
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-8">
						{/* Vendor */}
						<div>
							<h3 className="text-lg font-bold text-purple-600 mb-3">Vendor</h3>
						...
						{/* Buyer */}
						<div>
							<h3 className="text-lg font-bold text-purple-600 mb-3">Buyer</h3>
							{selectedClientData ? (
								<div className="bg-purple-50 p-5 rounded-lg">
