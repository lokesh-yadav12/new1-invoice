...
const Footer = () => {
	const companyLinks = [
		{ name: 'About Us', href: 'https://elite8digital.in/#/about' },
		{ name: 'Contact Us', href: 'https://elite8digital.in/#/contact' },
		{ name: 'Blog', href: 'https://www.instagram.com/p/DRSGr2UEmoe/?img_index=1' },
	];
		...
		<footer className="w-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-300 relative overflow-hidden">
			...
			<div className="relative max-w-7xl mx-auto  sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-8">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-11 gap-8 lg:gap-2 mb-6">
					...
					<div className=" lg:col-span-3 flex flex-col gap-3  sm:gap-6">
						...
						<div className="flex flex-col ml-6  ">
							...
							<div className="flex gap-2 mr-4">
								<a
									href="https://www.facebook.com/people/Elite8-Digital/61578168604952/"
					...
					{/* Company Section */}
					<div className="lg:col-span-2 px-4 mx-4 sm:mx-0">
					...
					{/* Contact Section */}
					<div className="lg:col-span-2 px-3 mx-4 sm:mx-0">
						<h3 className="text-white text-lg font-bold mb-6 relative">
							Get In Touch
							<span className="absolute bottom-0 left-0 w-12 h-1 bg-gradient-to-r from-purple-600 to-blue-600 -mb-3"></span>
						</h3>
						<div className="space-y-2">
							...
							>
								...
								<div className="flex flex-col">
									...
									<span className="text-sm font-medium">6260894977</span>
								</div>
							</a>

							{/* WhatsApp */}
							<a
								href="https://wa.me/+91 6260-894977"
								className="flex items-center gap-3 text-gray-400 hover:text-white transition-all duration-300 group"
							>
								<div className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center group-hover:bg-gradient-to-br group-hover:from-purple-600 group-hover:to-blue-600 transition-all duration-300">
									<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
							...
							>
								...
								<div className="flex flex-col">
									...
									<span className="text-sm font-medium break-all">Contact@elite8digital.in</span>
								</div>
							</a>
						</div>
					</div>
					...
					<div className="max-w-2xl mx-auto text-center">
						...
						<div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
							<input
								...
								className="flex-1 px-4 sm:mx-2 mx-10 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-purple-600 transition-colors"
							/>
							<button className="px-6 mx-10 sm:mx-2 py-3 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold rounded-lg hover:from-purple-700 hover:to-blue-700 transition-all duration-300 transform hover:scale-105">
								Subscribe
							</button>
						</div>
					</div>
				...
				<div className="border-t border-gray-800 pt-4 mt-6">
					<div className="flex gap-1 sm:gap-2 justify-center items-center">
						<p className="text-gray-400 text-sm sm:text-lg text-center">&copy; Built with ❤️ by Elite8 Digital</p>
						<img
							src="/elite8digital-nav.png"
							alt="Elite8 Digital Logo"
